...
class UNetMNIST(nn.Module):
    def __init__(self):
        ...
        self.pool1 = nn.MaxPool2d(2, 2) # Output: [64, 14, 14]

        self.e21 = nn.Conv2d(64, 128, kernel_size=3, padding=1)
        self.e22 = nn.Conv2d(128, 128, kernel_size=3, padding=1)
        self.pool2 = nn.MaxPool2d(2, 2) # Output: [128, 7, 7]
        ...
        self.upconv1 = nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2, output_padding=1) # To [128, 14, 14]
        self.d11 = nn.Conv2d(256, 128, kernel_size=3, padding=1)
        self.d12 = nn.Conv2d(128, 128, kernel_size=3, padding=1)

        self.upconv2 = nn.ConvTranspose2d(128, 64, kernel_size=2, stride=2) # To [64, 28, 28]
